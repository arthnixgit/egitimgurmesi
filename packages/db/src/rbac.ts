...
export const DEFAULT_PERMISSIONS = [
  ...
  { key: websiteRead, name: "Web sitesi goruntuleme", description: "Global web sitesi iceriklerini ve ayarlarini goruntuler." },
  { key: websiteManage, name: "Web sitesi duzenleme", description: "Global web sitesi sayfa, marka, footer ve materyal iceriklerini duzenler." },
  { key: websitePublish, name: "Web sitesi yayinlama", description: "Global web sitesi taslaklarini yayinlar ve revizyonlari yonetir." },
